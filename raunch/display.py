...
def render_server_startup(
    ...
    console.print(f"  [bold]w[/] [dim]<text>[/]          [dim]{bullet}[/]  Whisper to character")
    console.print(f"  [bold]a[/] [dim]<name>[/]          [dim]{bullet}[/]  Attach to character")
    console.print(f"  [bold]c[/], [bold]characters[/]     [dim]{bullet}[/]  List characters")
    console.print(f"  [bold]?[/], [bold]help[/]           [dim]{bullet}[/]  All commands")
